      ...
      <tr style="background-color: #323232;">
        <td style="padding: 10px; vertical-align: middle;">
          ...
          <h1 class="fallback-font"
            style="margin: 0px!important; font-family: 'Montserrat', sans-serif; font-size: 24px; color: #FFFFFF; text-align: center; font-weight: 700;">
      ...
      <tr style="background-color: #FFFFFF;">
        <td style="padding: 40px;">
          ...
          <h2 class="fallback-font"
            ...
            <strong>Hola {name_sales_client}</strong>
          </h2>
          ...
          <p class="fallback-font"
            ...
            Recibiste una nueva consulta desde {origin}
          </p>
          <br>
          <br>
            ...
            <tr>
              <td class="button-td button-td-primary" style="border-radius: 4px; background: #FFFFFF;">
                <a class="fallback-font button-a button-a-primary" target="_blank" rel="noopener"
                  ...
                  style="background: #FFFFFF; border: 1px solid #FFFFFF; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; font-weight: 700; text-decoration: none; padding: 10px 20px; color: #f7af31; display: block; border-radius: 4px;">RESPONDER
                </a>
              </td>
            </tr>
          </table>
