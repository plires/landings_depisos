...
<head>
  ...
  <title>{name_client} - {sector_client}</title>
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
      ...
      <tr>
        <td style="vertical-align: middle;">
          ...
          <img src="{base}img-emails/header-email-griferias.jpg"
      ...
      <tr style="background-color: #FFFFFF;">
        <td style="padding: 40px;">
          ...
          <p class="fallback-font"
            ...
            Mi nombre es {name_sales_client}, trabajo en el sector de <strong>{sector_client} de
              {name_client}.</strong><br><br>
            Quiero agradecer tu contacto y comentarte que voy a analizar detenidamente tu requerimiento para buscar la
            mejor alternativa que ofrecerte, tanto en productos, precios como también formas de pago.
          </p>
          <br>
          <br>
          ...
          <p class="fallback-font"
            style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #575756; text-align: right; font-weight: 700;">
            <strong>{name_sales_client}</strong><br>
            <strong>{sector_client}</strong><br>
            <strong>
              <a class="fallback-font"
                style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #575756; text-align: right; font-weight: 700;"
                target="_blank" rel="noopener noreferrer" href="mailto:{email_sales_client}"> {email_sales_client}
              </a>
            </strong><br>
            <strong>
              <a class="fallback-font"
                style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #575756; text-align: right; font-weight: 700;"
                target="_blank" rel="noopener noreferrer" href="{whatsapp_href_sales_client}"> {whatsapp_sales_client}
              </a>
            </strong><br>
          </p>
      ...
      <tr style="background-color: #f7af31;">
        <td style="background-color: #f7af31; text-align: center; padding: 40px;">
            ...
            <tr>
              <td class="button-td button-td-primary" style="border-radius: 4px; background: #FFFFFF;">
                <a class="fallback-font button-a button-a-primary" target="_blank" rel="noopener" href="{base}"
                  style="background: #FFFFFF; border: 1px solid #FFFFFF; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; font-weight: 700; text-decoration: none; padding: 10px 20px; color: #f7af31; display: block; border-radius: 4px;">VER
                  MÁS
                </a>
              </td>
            </tr>
      ...
      <tr align="center" style="background-color: #FFFFFF;">
        <td align="center" style="background-color: #FFFFFF;padding: 10px;">
          ...
          <a target="_blank" rel="noopener noreferrer" href="{facebook}">
            <img src="{base}img-emails/facebook.png"
              style="margin:0; margin-right: 20px; padding:0; border:none; display:inline-block; width: 32px; height: auto;"
              border="0" alt="facebook" />
          </a>

          <a target="_blank" rel="noopener noreferrer" href="{instagram}">
            <img src="{base}img-emails/instagram.png"
              style="margin:0; margin-right: 0; padding:0; border:none; display:inline-block; width: 32px; height: auto;"
