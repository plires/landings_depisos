      ...
      <div class="row">
        <div class="col-md-10 m-auto col-lg-12">
          <p class="wow fadeInUp">
            Los revestimientos están desarrollados en WPC, lo que los convierte en productos de <span>LIBRE
              MANTENIMIENTO,</span> ideales para soluciones definitivas en paredes de exterior e interior.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 offset-md-1 wow fadeInUp">
          ...
          <p>
            Ideal para renovar o resaltar fachadas, muros y grandes superficies. <br>Tambien utilizados en interiores
            otorgando un efecto único y dependiendo del diseño seleccionado, pueden cambiar por completo un ambiente
            <span>Solución rápida y ecológica.</span> Material WPC superior al PVC.
          </p>
