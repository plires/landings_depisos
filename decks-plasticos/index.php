...
<head>
  ...
  <meta name="description"
    content="Decks plasticos. Fabricado con materiales reciblables. No se pudre ni se astilla. Sin Matenimiento.">
  ...
  <section class="container lineas">
    ...
    <div class="row">
      <div class="col-md-12 wow fadeInUp">
        <h2>DECKS PLÁSTICOS: <span>LÍNEAS</span></h2>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12 wow fadeInUp">
        <h4>
          ...
          <img class="img-fluid" src="img/sistema-click.jpg" alt="sistema de fijacion oculta para decks plasticos">
        </h4>
      </div>
    </div>
  </section>
  ...
  <section class="container varios">
    ...
    <div class="row caracteristicas wow fadeInUp">
      ...
      <div class="col-md-6">
        <ul>
          <li>
            <img class="img-fluid" src="img/tilde.png" alt="deck plasticos tilde 1">
            <p>Libre de Mantenimiento</p>
          </li>
          <li>
            <img class="img-fluid" src="img/tilde.png" alt="deck plasticos tilde 2">
      ...
      <div class="col-md-6">
        <ul>
          <li>
            <img class="img-fluid" src="img/tilde.png" alt="deck plasticos tilde 3">
            <p>Superior a la Madera y al deck de PVC</p>
          </li>
          <li>
            <img class="img-fluid" src="img/tilde.png" alt="deck plasticos tilde 4">
    ...
    <div class="row beneficios">
      ...
      <div class="col-4 wow fadeInLeft">
        <img class="img-fluid" src="img/presupuesto-sin-cargo.png" alt="deck plasticos presupuestos sin cargo">
        <p>Presupuestos Sin cargo</p>
      </div>

      <div data-wow-delay="0.3s" class="col-4 wow fadeInLeft">
        <img class="img-fluid" src="img/cuotas-fijas.png" alt="deck plasticos Cuotas fijas en pesos">
        <p>Ahora 12 Cuotas fijas en pesos</p>
      </div>

      <div data-wow-delay="0.6s" class="col-4 wow fadeInLeft">
        <img class="img-fluid" src="img/importadores-directos.png" alt="deck plasticos Importadores Directos">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 offset-md-1 wow fadeInUp">
          <h2>DECKS PLÁSTICOS: APLICACIONES RECOMENDADAS</h2>
          <p>
            Nuestros <span>Decks Ecológicos</span>, vulgarmente conocidos como decks de PVC o decks plásticos, son
            altamente recomendados para piletas, piscinas, balcones, espacios exteriores, terrazas, revestimiento de
            fachadas, entre muchos otros usos.
          </p>
