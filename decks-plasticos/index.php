...
<head>
	...
	<meta name="description" content="Decks Plástico. Fabricado con materiales reciblables. No se pudre ni se astilla. Sin Matenimiento.">
	<meta name="author" content="Librecomunicacion">
    <!-- Favicons -->
    <?php include('includes/favicon.inc.php'); ?>

	<title>Decks Plástico sin mantenimiento.</title>
...
<body>
	...
	<section class="container-fluid imagen_destacada">
		...
		<div class="mejores_marcas wow fadeInRight">
			<img class="img-fluid" src="img/ecologico.png" alt="deck trex y otras marcas en decks plasticos">
			<div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12">
					<h1 class="wow fadeInDown">DECKS <span>PLÁSTICOS</span></h1>
	...
	<section class="container lineas">
		...
		<div class="row">
			<div class="col-md-12 wow fadeInUp">
				<h2>DECK PLÁSTICO: <span>LÍNEAS</span></h2>
			</div>
		</div>

		<div class="row wow fadeInUp">
			<div class="col-md-6">
				<img class="img-fluid" src="img/trascend.jpg" alt="deck plástico trascend">
				<h3>TRASCEND</h3>
			</div>
			<div class="col-md-6">
				<img class="img-fluid" src="img/contour.jpg" alt="deck plástico contour">
				<h3>CONTOUR</h3>
			</div>
			<div class="col-md-6">
				<img class="img-fluid" src="img/enhance.jpg" alt="deck plástico enhance">
				<h3>ENHANCE</h3>
			</div>
			<div class="col-md-6">
				<img class="img-fluid" src="img/co-extruded.jpg" alt="deck plástico co-extruded">
				<h3>CO-EXTRUDED</h3>
			</div>
		</div>
	...
	<section class="container varios">
		...
		<div class="row caracteristicas wow fadeInUp">
			...
			<div class="col-md-6">
				<ul>
					<li>
						<img class="img-fluid" src="img/tilde.png" alt="deck plástico tilde 1">
						<p>Libre de Mantenimiento</p>
					</li>
					<li>
						<img class="img-fluid" src="img/tilde.png" alt="deck plástico tilde 2">
			...
			<div class="col-md-6">
				<ul>
					<li>
						<img class="img-fluid" src="img/tilde.png" alt="deck plástico tilde 3">
						<p>Superior a la Madera</p>
					</li>
					<li>
						<img class="img-fluid" src="img/tilde.png" alt="deck plástico tilde 4">
		...
		<div class="row beneficios">
			...
			<div class="col-4 wow fadeInLeft">
				<img class="img-fluid" src="img/presupuesto-sin-cargo.png" alt="deck plástico presupuestos sin cargo">
				<p>Presupuestos Sin cargo</p>
			</div>

			<div data-wow-delay="0.3s" class="col-4 wow fadeInLeft">
				<img class="img-fluid" src="img/cuotas-fijas.png" alt="deck plástico Cuotas fijas en pesos">
				<p>Ahora 12 Cuotas fijas en pesos</p>
			</div>

			<div data-wow-delay="0.6s" class="col-4 wow fadeInLeft">
				<img class="img-fluid" src="img/importadores-directos.png" alt="deck plástico Importadores Directos">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-10 offset-md-1 wow fadeInUp">
					<h2>DECK PLÁSTICO: APLICACIONES RECOMENDADAS</h2>
					<p>
						Nuestros <span>Decks ecológicos</span> son altamente recomendados para piletas, piscinas, balcones, espacios exteriores, terrazas, revestimiento de fachadas, entre muchos otros usos.
					</p>
