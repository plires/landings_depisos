        ...
        <!-- Header-->
          <tr>
              <td style="vertical-align: middle;">
                  ...
                  <img src="{img_header}" style="margin:0; padding:0; border:none; display:block; width: 100%; height: auto;" border="0" alt="header" />
          ...
          <tr style="background-color: #FFFFFF;">
              <td style="padding: 40px;">
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: left; font-weight: 400;">
                      <strong>Sucursal de preferencia:</strong> {store}
                  </p>
