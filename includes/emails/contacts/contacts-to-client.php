        ...
        <!-- Header-->
          ...
          <tr style="background-color: #323232;">
              <td style="padding: 10px; vertical-align: middle;">
                  ...
                  <h1 class="fallback-font" style="margin: 0px!important; font-family: 'Montserrat', sans-serif; font-size: 24px; color: #FFFFFF; text-align: center; font-weight: 700;">
                      <strong>Nueva consulta desde {origin}</strong><br>
                      <strong>Para Sucursal {store}</strong>
                  </h1>
