...
<head>
	...
	<title>Decks Ecológicos sin mantenimiento.</title>
	...
	<section class="container lineas">
		...
		<div class="row">
			<div class="col-md-12 wow fadeInUp">
				<h2>DECKS ECOLÓGICOS: <span>LÍNEAS</span></h2>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 wow fadeInUp">
				<h4>
					...
					<img class="img-fluid" src="img/sistema-click.jpg" alt="sistema de fijacion oculta para decks ecologicos">
				</h4>
			</div>
		</div>
	</section>
	...
	<section class="container varios">
		...
		<div class="row caracteristicas wow fadeInUp">
			...
			<div class="col-md-6">
				<ul>
					<li>
						<img class="img-fluid" src="img/tilde.png" alt="deck ecologicos tilde 1">
						<p>Libre de Mantenimiento</p>
					</li>
					<li>
						<img class="img-fluid" src="img/tilde.png" alt="deck ecologicos tilde 2">
			...
			<div class="col-md-6">
				<ul>
					<li>
						<img class="img-fluid" src="img/tilde.png" alt="deck ecologicos tilde 3">
						<p>Superior a la Madera y al deck de PVC</p>
					</li>
					<li>
						<img class="img-fluid" src="img/tilde.png" alt="deck ecologicos tilde 4">
		...
		<div class="row beneficios">
			...
			<div class="col-4 wow fadeInLeft">
				<img class="img-fluid" src="img/presupuesto-sin-cargo.png" alt="deck ecologicos presupuestos sin cargo">
				<p>Presupuestos Sin cargo</p>
			</div>

			<div data-wow-delay="0.3s" class="col-4 wow fadeInLeft">
				<img class="img-fluid" src="img/cuotas-fijas.png" alt="deck ecologicos Cuotas fijas en pesos">
				<p>Ahora 12 Cuotas fijas en pesos</p>
			</div>

			<div data-wow-delay="0.6s" class="col-4 wow fadeInLeft">
				<img class="img-fluid" src="img/importadores-directos.png" alt="deck ecologicos Importadores Directos">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-10 offset-md-1 wow fadeInUp">
					<h2>DECKS ECOLÓGICOS: APLICACIONES RECOMENDADAS</h2>
					<p>
