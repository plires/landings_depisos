...
<html lang="es">
	...
	<head>
		...
		<meta name="description" content="Pisos vinilicos a prueba de agua. Colores simil madera. Las mejores marcas en pisos y el mejor precio del mercado">
		<meta name="author" content="Librecomunicacion">

	  <!-- Favicons -->
	  <?php include('./../includes/favicon.inc.php'); ?>
	  
		<title>Pisos vinilicos. Pisos a prueba de agua</title>
		...
		<section class="container tipologia">
			<div class="row">
				<div class="col-md-12 wow fadeInUp">
					...
					<img class="img-fluid liston_baldosa" src="img/liston-baldosa.jpg" alt="pisos vinilicos en listones y baldosas">
				</div>
			</div>
		</section>
		<!-- Tipologia end -->
		...
		<section class="container varios">
			...
			<div class="row caracteristicas wow fadeInUp">
				...
				<div class="col-md-6">
					<ul>
						<li>
							<img class="img-fluid" src="img/tilde.png" alt="pisos vinilicos tilde 1">
							<p>Resistentes 100% al agua</p>
						</li>
						<li>
							<img class="img-fluid" src="img/tilde.png" alt="pisos vinilicos tilde 2">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 offset-md-1 wow fadeInUp">
						...
						<p>
							Los pisos vinílicos son ideales para entornos comerciales y domésticos. Desarrollados con materiales de primera calidad. <br> <span>Aptos para alto tránsito.</span>
						</p>
