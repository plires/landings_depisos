...
<head>
  ...
  <title>Pisos de Porcelanatos Vite. Las mejores marcas. Nacionales e importados</title>
...
<body>
  ...
  <!-- Faja Vite -->
  <section class="container-fluid faja_vite">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="wow fadeInUp">CONTAMOS CON LOS PRINCIPALES
            MODELOS DE <span>PORCELANATOS VITE</span>
          </h2>

          <div id="carouselVite" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="./img/vite/slide-vite-a.jpg" class="d-block w-100" alt="porcelanato vite - a">
              </div>
              <div class="carousel-item">
                <img src="./img/vite/slide-vite-b.jpg" class="d-block w-100" alt="porcelanato vite - b">
              </div>
              <div class="carousel-item">
                <img src="./img/vite/slide-vite-c.jpg" class="d-block w-100" alt="porcelanato vite - c">
              </div>
            </div>
            <button class="carousel-control-prev" type="button" data-target="#carouselVite" data-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="sr-only">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-target="#carouselVite" data-slide="next">
          ...
          <div class="content_vite">
            <p>
              <span>Texturas y colores que son tendencia en la decoración actual:</span>
              Porcelanato vite pecan, urban light grey, calacata pulido, liscio,
              liscio light grey, antico y muchos más.
            </p>
          </div>
  ...
  <section class="container lineas">
    ...
    <div class="row wow fadeInUp">
      <div class="col-md-6">
        <img class="img-fluid" src="img/linea-vite.jpg" alt="linea porcelanatos vite">
        <h3>VITE</h3>
      </div>

      <div class="col-md-6">
        <img class="img-fluid" src="img/linea-tendenza.jpg" alt="linea porcelanatos tendenza">
        <h3>PRCELÁNICOS TENDENZA</h3>
      </div>
      <div class="col-md-6">
