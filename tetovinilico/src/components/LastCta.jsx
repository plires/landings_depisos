...
const LastCta = () => {
  ...
  const msg = isPromo
    ? 'Quiero consultar por los cielorrasos de Teto Vinílico y los descuentos de esta promoción en curso...'
    : 'Quiero consultar por los cielorrasos de Teto Vinílico...'
